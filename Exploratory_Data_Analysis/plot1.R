...
# Plot 1: ExDataCP1Plot1.png - Global Active Power - Frequency (Histogram)
hist(DT$ Global_active_power, xlab = " Global Active Power (kilowatts)", ylab = "Frequency", col = "red", main = "Global Active Power")
